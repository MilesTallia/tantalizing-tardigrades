...
var project_costs = {
	...
	"Community Solar Microgrid Implementation": "The cost of implementing the solar microgrid is estimated to be %s thousand dollars.",
	"Urban Green Roof Expansion": "The expansion of green roofs across urban areas will cost approximately %s thousand dollars.",
	"Coastal Wetland Restoration Project": "The restoration project for coastal wetlands is expected to cost %s thousand dollars.",
	"Reforestation and Native Species Planting": "Reforestation efforts and planting native species will require an investment of %s thousand dollars.",
	"Public Transportation Electrification": "Electrifying public transportation systems is projected to cost %s thousand dollars.",
	"Sustainable Agriculture and Food Distribution": "The cost to implement sustainable agriculture and food distribution systems is estimated at %s thousand dollars.",
	"Wildlife Corridor Development": "Developing wildlife corridors to reconnect ecosystems is estimated to cost %s thousand dollars.",
	"Water Conservation and Purification Initiative": "The water conservation and purification initiative will cost approximately %s thousand dollars.",
	"Renewable Energy Storage Deployment": "Deploying renewable energy storage solutions will require an investment of %s thousand dollars.",
	"Habitat Restoration and Invasive Species Removal": "The cost of habitat restoration and invasive species removal is projected to be %s thousand dollars.",
	"Solar Farm Construction": "Building a solar farm will cost around %s thousand dollars in total.",
	"Wind Turbine Installation": "The installation of wind turbines is projected to cost %s thousand dollars.",
	"Hydroelectric Dam Upgrade": "Upgrading hydroelectric dams is expected to cost %s thousand dollars.",
	"Geothermal Energy Plant Development": "Developing a geothermal energy plant will require an investment of %s thousand dollars.",
	"Biomass Energy Facility Construction": "The construction of a biomass energy facility is expected to cost %s thousand dollars.",
	"Renewable Energy Grid Interconnection": "The cost of interconnecting renewable energy sources to the grid is %s thousand dollars.",
	"Energy Efficiency Improvement Program": "Implementing energy efficiency improvements across systems is estimated to cost %s thousand dollars.",
	"Sustainable Building Construction": "Constructing sustainable buildings will require an estimated %s thousand dollars.",
	"Electric Vehicle Charging Infrastructure": "Expanding electric vehicle charging infrastructure will cost around %s thousand dollars.",
	"Smart Grid Technology Deployment": "Deploying smart grid technology is expected to cost %s thousand dollars.",

	# Harmful Projects (with money gained)
	"Strategic Defoliation Initiative": "The defoliation initiative is expected to generate a profit of %s thousand dollars from increased agricultural yields.",
	"Deep Bore Nuclear Waste Storage": "Storing nuclear waste deep underground is expected to generate revenue of %s thousand dollars from waste disposal contracts.",
	"Experimental Seismic Testing (Fracking)": "Fracking and seismic testing will generate an income of %s thousand dollars through resource extraction deals.",
	"Remote Arctic Resource Exploitation": "Exploiting resources in the Arctic will bring in %s thousand dollars from mining and oil extraction.",
	"Unregulated Deep-Sea Mining": "Deep-sea mining without regulation could generate profits of %s thousand dollars from mineral extraction.",
	"Forced Relocation for Dam Construction": "Forced relocation for dam construction could lead to profits of %s thousand dollars through development and land deals.",
	"Large-Scale Incineration Project": "Large-scale incineration of waste could generate %s thousand dollars through waste processing contracts.",
	"Controversial Pesticide Deployment": "Deploying controversial pesticides is expected to generate %s thousand dollars from agricultural industry contracts.",
	"Offshore Oil Platform Expansion": "Expanding offshore oil platforms is expected to yield %s thousand dollars from increased oil production.",
	"Unmonitored Chemical Waste Discharge": "Unmonitored chemical waste discharge will result in profit gains of %s thousand dollars from reduced operational costs.",
	"Tax Haven Resource Transfer": "Transferring resources through tax havens could lead to profits of %s thousand dollars by evading taxation.",
	"Lobby-Driven Regulatory Exemption": "Lobby-driven regulatory exemptions are expected to generate %s thousand dollars in savings through fewer environmental constraints.",
	"Subsidized Fossil Fuel Infrastructure": "Subsidizing fossil fuel infrastructure will lead to an income of %s thousand dollars through expanded fuel production.",
	"Offshore Data Storage (for tax evasion)": "Offshore data storage for tax evasion purposes will generate %s thousand dollars by reducing costs related to taxation and regulations.",
	"Non-Disclosure Agreement Land Acquisition": "Land acquisition via non-disclosure agreements will lead to profits of %s thousand dollars from undisclosed development projects.",
	"Strategic Price Fixing Initiative": "Price fixing in the fossil fuel sector will generate %s thousand dollars in additional profits for participating companies.",
	"Environmental Impact Report Suppression": "Suppressing environmental impact reports will save %s thousand dollars in avoided environmental mitigation costs.",
	"Delayed Infrastructure Maintenance": "Delaying infrastructure maintenance will save %s thousand dollars in short-term operational costs but will increase long-term costs.",
	"Political Campaign Funding (Lobbying)": "Political lobbying and campaign funding will generate %s thousand dollars by influencing regulations in favor of polluting industries.",
	"Contract Bid Rigging": "Rigging contracts in favor of certain companies will generate %s thousand dollars in profits through unfair contract allocations."
}
